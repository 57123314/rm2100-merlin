...
#if defined(CONFIG_MODEL_RTAC85U) || defined(CONFIG_MODEL_RTAC85P) || defined(CONFIG_MODEL_RTAC65U) || defined(CONFIG_MODEL_RTN800HP) || defined(CONFIG_MODEL_RTACRH26) || defined(CONFIG_MODEL_RTRM2100)//ASUS_EXT
...
{
#if defined (CONFIG_MODEL_RTAC85U) || defined(CONFIG_MODEL_RTAC85P) || defined(CONFIG_MODEL_RTAC65U) || defined(CONFIG_MODEL_RTN800HP) || defined(CONFIG_MODEL_RTACRH26) || defined(CONFIG_MODEL_RTRM2100)  	//only initialize at boot time.
 	   if(!first_gsw_init) 
		first_gsw_init=1;
