...
function initial(){
	...
	/* MODELDEP */
	if(based_modelid == "RT-AC85U" || based_modelid == "RT-AC85P" || based_modelid == "RT-AC65U" || based_modelid == "RT-RM2100"){
		if(qos_type_orig == "1"){
			document.getElementById('bandwidth_setting_tr').style.display = "none";
...
function change_qos_type(value){
	/* MODELDEP */
	if(value=="1" && (based_modelid == "RT-AC85U" || based_modelid == "RT-AC85P" || based_modelid == "RT-AC65U" || based_modelid == "RT-RM2100")){	//Force change to 0
		value = 0;
	}
